...
public class MVPGame {
    ...
    // Внутренний класс для хранения состояния игры, реализует интерфейс Serializable для сохранения в файл
    ...
    static GameState gameState; // Глобальное состояние игры
    static final Scanner scanner = new Scanner(System.in); // Сканер для ввода данных пользователем
    ...
    static void conquerTerritory(boolean isPlayer) {
        try {
    ...
    // Обработка событий конца дня (пустой метод, можно добавить логику)
    ...
    // Сохранение истории игры в файл Excel
    static void saveHistoryToExcel() {
